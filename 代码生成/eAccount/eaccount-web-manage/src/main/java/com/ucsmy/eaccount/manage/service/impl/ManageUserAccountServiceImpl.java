...
public class ManageUserAccountServiceImpl extends BasicServiceImpl<ManageUserAccount, ManageUserAccountDao> implements ManageUserAccountService {
    ...
    protected RetMsg saveHandle(ManageUserAccount entity) {
        ...
        String passwordMd5 = DigestUtils.md5Hex(entity.getPassword());//TODO MD5加密
    ...
    @Override
    public List<ManageUserAccount> getByUserIdList(List<String> userNames) {
        return this.dao.getByUserIdList(userNames);
    }
...
//        entity.setPassword(StringUtils.passwordEncrypt(entity.getAccount(), entity.getPassword(), entity.getSalt()));//弃用
