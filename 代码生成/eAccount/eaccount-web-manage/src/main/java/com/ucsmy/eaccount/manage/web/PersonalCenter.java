...
//        oldPassword = StringUtils.passwordEncrypt(userAccount.getAccount(), oldPassword, userAccount.getSalt());//该方式加密已弃用
//        oldPassword = DigestUtils.md5Hex(oldPassword);//TODO MD5加密
