...
public class ManageUserProfileServiceImpl extends BasicServiceImpl<ManageUserProfile, ManageUserProfileDao> implements ManageUserProfileService {
    ...
    @Override
    public List<ManageUserProfile> listByUserIds(List<ManageUserAccount> users) {
        return this.dao.listByUserIds(users);
    }

    @Override
    public ManageUserProfile getUserProfileByUserName(String userName) {
        return this.dao.getUserProfileByUserName(userName);
    }

    @Override
    public List<ManageUserProfile> getLists() {
